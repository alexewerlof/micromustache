import { render, compile } from '../lib/index.js'
...
function micromustacheLong() {
    return render(longTemplate, longScope, { maxPathLen: 999999 })
}
...
const longCompiled = compile(longTemplate, { maxPathLen: 999999 })
function micromustacheLongCompiled() {
    return longCompiled.render(longScope)
}
...
function micromustacheDiverse() {
    return render(diverseTemplate, diverseScope)
}
...
function micromustacheDeep() {
    return render(deepTemplate, deepScope, { maxRefDepth: LEN, maxPathLen: 999999 })
}
...
compare(micromustacheLongCompiled, mustacheLong)
